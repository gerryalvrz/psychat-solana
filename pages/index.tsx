            ...
            <div className="max-w-6xl mx-auto">
              <div className="relative overflow-hidden rounded-2xl crystal-glass crystal-glass-hover refraction-overlay transition-all duration-300 border-cyan-400/20 shadow-[0_0_20px_rgba(0,255,255,0.1)] crystal-panel crystal-layer-2">
                ...
                <div className="relative z-10 p-4 flex justify-between items-center">
                  ...
                  >
                    <h1 
                      className="text-2xl font-bold tracking-wider psychat-neon relative"
                      style={{ 
                    ...
                    >
                      ...
                      {/* Neon glow effect */}
                      <span 
                        className="absolute inset-0 text-2xl font-bold tracking-wider opacity-40 blur-sm group-hover:opacity-60 transition-opacity duration-300"
                        style={{ 
                          fontFamily: 'Orbitron, monospace',
                    ...
                    <span className="text-sm text-white/70 group-hover:text-cyan-300 transition-colors duration-300">by MotusDAO</span>
                  </button>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center w-10 h-10 rounded-lg bg-black/40 border border-gray-700 hover:bg-black/60 transition-colors"
                      title={isDockVisible ? "Hide Navigation" : "Show Navigation"}
                    >
                      <div className="w-4 h-4 flex flex-col justify-center space-y-1">
                        <div className={`w-full h-0.5 bg-white transition-all duration-300 ${isDockVisible ? 'rotate-45 translate-y-1' : ''}`} />
                        <div className={`w-full h-0.5 bg-white transition-all duration-300 ${isDockVisible ? 'opacity-0' : ''}`} />
                        <div className={`w-full h-0.5 bg-white transition-all duration-300 ${isDockVisible ? '-rotate-45 -translate-y-1' : ''}`} />
                      </div>
                    </button>
